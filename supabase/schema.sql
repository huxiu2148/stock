...
declare
  t text;
begin
  foreach t in array array['salary_records','overtime_entries','late_entries','leave_entries','leave_balances','stock_trades','user_settings','loans','loan_payments','credit_cards','credit_card_statements','card_usage_tips']
  loop
